...
- 一键制作主题：输入主题名，选择控件配色、字体、字体颜色、明暗模式、首页文字遮罩和任务页面遮罩，预览图片后自动压缩生成主题文件夹，保存到本机主题库，立即启动/刷新皮肤，并自动打开效果截图。
...
- 任务页面遮罩可以选择智能、柔和背景、顶部横幅，或不显示背景图。
- 可自由调整的内容包括背景图、控件强调色、字体、字体颜色、明暗模式、首页遮罩和任务页面遮罩。为避免破坏 Codex 官方功能，不直接修改官方安装包或内部程序文件。
